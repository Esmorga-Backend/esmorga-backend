...
import {
  ...
  GET_USER_CREATED_EVENTS_HEADERS,
  JOIN_EVENT_HEADERS,
  LOGIN_HEADERS,
...
import {
  ...
  GET_USER_CREATED_EVENTS_RESPONSES,
...
export function SwaggerGetUserCreatedEvents() {
  return applyDecorators(
    ApiOperation({
      summary:
        'Return a list of events created by the user.',
    }),
    ApiHeader(GET_USER_CREATED_EVENTS_HEADERS.AUTHORIZATION_BEARER),
    ApiOkResponse(GET_USER_CREATED_EVENTS_RESPONSES.OK),
    ApiUnauthorizedResponse(GET_USER_CREATED_EVENTS_RESPONSES.UNAUTHORIZED_ERROR),
    ApiForbiddenResponse(GET_USER_CREATED_EVENTS_RESPONSES.FORBIDDEN_ERROR),
    ApiTooManyRequestsResponse(GET_USER_CREATED_EVENTS_RESPONSES.TOO_MANY_REQUESTS_ERROR),
    ApiInternalServerErrorResponse(GET_USER_CREATED_EVENTS_RESPONSES.INTERNAL_ERROR),
  );
}
