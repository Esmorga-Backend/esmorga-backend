...
export function SwaggerJoinEvent() {
  return applyDecorators(
    ...
    ApiUnprocessableEntityResponse(
      JOIN_EVENT_RESPONSES.UNPROCESSABLE_CONTENT_ERROR,
    ),
...
export function SwaggerDisjoinEvent() {
  return applyDecorators(
    ...
    ApiUnprocessableEntityResponse(
      DISJOIN_EVENT_RESPONSES.UNPROCESSABLE_CONTENT_ERROR,
    ),
...
export function SwaggerUpdatePassword() {
  return applyDecorators(
    ...
    ApiUnprocessableEntityResponse(
      UPDATE_PASSWORD_RESPONSES.UNPROCESSABLE_CONTENT_ERROR,
    ),
    ApiTooManyRequestsResponse(
