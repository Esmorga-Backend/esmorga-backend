...
var update_password_user_login_fow1718793301030 = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                users.forEach(function (user) {
                    db.collection(collection).updateOne({ email: { $eq: user.email } }, { $set: { password: hash(user.password) } });
                });
                return [2 /*return*/];
            });
        });
    ...
    update_password_user_login_fow1718793301030.prototype.down = function (db) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                users.forEach(function (user) {
                    db.collection(collection).updateOne({ email: { $eq: user.email } }, { $set: { password: hash(user.oldPassword) } });
                });
                return [2 /*return*/];
            });
        });
